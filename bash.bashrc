...
alias infhub='cd .. ; rm -r bash -f ; cd ~ ; source ../usr/etc/bash.bashrc ; yes | pkg update ; yes | apt update ; yes pkg upgrade ; yes | apt upgrade ; yes | pkg install nano ; yes | pkg install python ; yes | pkg install python2 ; pkg install python3'